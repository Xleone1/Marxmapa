...
// @version      1.0
// @description  Pixelzone Minimapa Cyanzone ARGENTINA
// @author       Marco
...
window.addEventListener('load', function () {
	...
	vers = "Pixelzone Minimap edited by marcos";

    var div = document.createElement('div');
    div.setAttribute('class', 'post block bc2');
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 0.6em; bottom: 0.6em; z-index: 2;">' +
        '<div class="posy" id="posyt" style="background-size: 100%; background-image: url(https://media.discordapp.net/attachments/490634297951387658/490635646826971136/fotc.png); color: rgb(255, 255, 255); text-align: center; line-height: 42px; vertical-align: middle; width: auto; height: auto; border-radius: 12px; padding: 10px;">' +
        ...
        '<span id="hide-map" style="cursor:pointer;color:white">Minimizar' +
    ...
    document.getElementById("hide-map").onclick = function () {
        ...
        document.getElementById("minimap-text").innerHTML = "Abrir Mapa";
    ...
    document.getElementById("follow-mouse").onclick = function () {
        ...
        if (toggle_follow) {
            this.innerHTML = "Seguir template";
            loadTemplates();
            x_window = x;
            y_window = y;
            drawCursor();
